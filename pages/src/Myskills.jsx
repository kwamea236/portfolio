    ...
    return(
        <section>
            ...
            <div className="lg:flex gap-10 justify-center">
                ...
                <div className="text-center p-10 rounded-2xl mt-10 border hover:shadow-xl dark:bg-white">
                  <Image src={javascript} width={100} height={100} className="mx-auto lg:mx-auto md:mx-auto" />
            ...
            */}
               ...
               */}
               ...
               <div className="lg:flex gap-10 justify-center">
                <div className="text-center p-10 rounded-2xl mt-10 border hover:shadow-xl dark:bg-white">
                  <Image src={postgres} width={100} height={100} className="mx-auto lg:mx-auto md:mx-auto" />
                  <h3 className="text-lg font-medium">PosgresQl</h3>
                </div>

                <div className="text-center p-10 rounded-2xl mt-10 border hover:shadow-xl dark:bg-white">
                  <Image src={mysql} width={100} height={100} className="mx-auto lg:mx-auto md:mx-auto" />
                  <h3 className="text-lg font-medium">My sql</h3>
                </div>

                <div className="text-center p-10 rounded-2xl mt-10 border hover:shadow-xl dark:bg-white">
                  <Image src={expressjs} width={100} height={100} className="mx-auto lg:mx-auto md:mx-auto" />
